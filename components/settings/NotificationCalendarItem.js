...
const NotificationCalendarItem = () => {
  ...
  return (
    <List.Accordion
      ...
      description={`Alert at ${
        calendarChoice.find((choice) => choice.duration === calendarSelection)
          .title
      }`}
      left={(props) => (
    ...
    >
      <EventNotificationItem
        ...
        setCalendarSelection={(selection) => setCalendarSelection(selection)}
      />
      <EventNotificationItem
...
export default NotificationCalendarItem;
